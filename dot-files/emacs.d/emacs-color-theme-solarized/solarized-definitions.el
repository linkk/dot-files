...
(defvar solarized-colors
  ...
  '((base03  "#002b36" "#002b36" "#002b36" "#002b36")
    (base02  "#073642" "#073642" "#073642" "#222222")
    (base01  "#111111" "#111111" "#111111" "#111111")
    (base00  "#3c4246" "#3c4246" "#3c4246" "#3c4246")
    (base0   "#657b83" "#657b83" "#657b83" "#657b83")
    (base1   "#828c8c" "#828c8c" "#828c8c" "#828c8c")
    (base2   "#eaeaea" "#eaeaea" "#eaeaea" "#eaeaea")
    (base3   "#fdfdfd" "#fdfdfd" "#fdfdfd" "#fdfdfd")
    ...
    (lblue   "#c2e3f6" "#c2e3f6" "#c2e3f6" "#c2e3f6")
    (black   "#000000" "#000000" "#000000" "#000000")
    (cyan    "#2aa198" "#259185" "#00afaf" "#00cdcd")
    (green   "#7d8f02" "#7d8f02" "#7d8f02" "#7d8f02"))
        ...
        (cond ((eq 'high solarized-contrast)
              ...
              ((eq 'low solarized-contrast)
               (setf back      base02
                     opt-under t)))
        `((;; basic
           (default ((t (:foreground ,base1 ,:background ,back))))
           (cursor
            ((t (:foreground ,base0 :background ,base0 :inverse-video t))))
           (escape-glyph-face ((t (:foreground ,red))))
           (fringe ((t (:foreground ,base03 :background ,base03))))
           (linum ((t (:foreground ,base01 :background ,base03))))
           (header-line ((t (:foreground ,base03 :background ,base2))))
           ...
           (mode-line
            ((t (:foreground ,base1 :background ,back
                             :box (:line-width -1 :color ,base00)))))
           (mode-line-buffer-id ((t (:foreground ,base1))))
           (mode-line-inactive
            ((t (:foreground ,base1  :background ,back
                             :box (:line-width -1 :color ,base00)))))
           (region ((t (:background ,lblue))))
           ...
           (emacs-wiki-link-face
            ((t (:foreground ,base03 :underline ,underline))))
           (emacs-wiki-verbatim-face
            ((t (:foreground ,base00 :underline ,underline))))
           ;; font-lock
           (font-lock-builtin-face ((t (:foreground ,base1)))) ;cyan
           (font-lock-comment-face ((t (:foreground ,base00 :slant ,italic))))
           (font-lock-constant-face ((t (:foreground ,base1)))) ;cyan
           (font-lock-function-name-face ((t (:foreground ,blue))))
           (font-lock-keyword-face ((t (:foreground ,base0 :weight ,bold))))
           (font-lock-string-face ((t (:foreground ,base1)))) ;cyan
           (font-lock-type-face ((t (:foreground ,blue))))
           (font-lock-variable-name-face ((t (:foreground ,base1)))) ;green
           (font-lock-warning-face ((t (:foreground ,red))))
           (font-lock-doc-face ((t (:foreground ,base1 :slant ,italic)))) ;cyan
           (font-lock-color-constant-face ((t (:foreground ,yellow))))
           (font-lock-comment-delimiter-face
            ((t (:foreground ,base00))))
           (font-lock-doc-string-face ((t (:foreground ,base1)))) ;cyan
           (font-lock-preprocessor-face ((t (:foreground ,orange))))
           (font-lock-reference-face ((t (:foreground ,base1)))) ;cyan
           ...
           (gnus-header-name ((t (:foreground ,base02))))
